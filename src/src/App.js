              ...
              elements: [
                {
                  type: "html",
                  name: "introSection1",
                  html: `<p style='font-size: 1rem; font-weight: 500; text-align: right; color: gray '>(${dataForContext.contextId})</p><p style='font-size: 1.3rem; font-weight: 500;'>In this survey, we will ask you to evaluate different types of explanations. This survey is designed to study how different ways of explaining AI-assisted decisions are effective in providing the rationales on a decision (i.e., ${dataForContext.decisionQuestion}). The survey consists of four parts:                     <ul style='font-size: 1.1rem'>                    <li> <b>Demographic survey</b>: we will ask about basic demographic information                     <li> <b>Decision-making scenario</b>: we will illustrate a scenario on an AI-assisted decision-making context where you were given a decision based on a list of information the system collected and inferred about you (assuming it's correct). </li>                    <li> <b>Possible explanations</b>: you will read explanations on why you were given the decision in the scenario, which are written with different strategies. </li><li> <b>Evaluation</b>: Given the explanations, you will evaluate how those explanations are effective in multiple perspectives. </li></ul></p> <p><br><br><i>*Your Prolific worker ID will be used to distribute payment to you and will be stored with your responses. You may withdraw from the task at any time. When you complete the study, you will be compensated for your participation. You should be aware that your Prolific Worker ID can potentially be linked to personal information on your public profile page, depending on the settings you have for your profile. We will not attempt to access or share any such information; however, you will need to review the Prolific terms and service agreements to find out their plan for potential data breaches regarding your identifiable information.
                        <p>*This study is conducted by the researchers at the University of Pittsburgh. The survey is anonymous and no de-identified data will be collected. Your response data will only be shared in a de-identified manner. Please exit the webpage at any time if you do not want to participate. If you want to participate in this study, click the continue button below to start the survey. If you have any questions or concerns about this study, please contact us via yongsu.ahn@pitt.edu.</p>`
                }
              ]
            },
          ],
                ...
                },
                {
                  ...
                  elements: [
                    ...
                    },
                    {
                      type: "comment",
                      name: "feedback",
                      title: "Please leave a few words about your overall choices, e.g., what is the most important aspect of explanations for you? Do you have any additional comments about the AI system?",
                      isRequired: true
                    },
                    {
                      type: "html",
